...
**[Télécharger directement l’APK 0.9.5](https://github.com/Uhama91/DictAI/releases/download/gemma-test-34404357683/dictai-local-layout-test.apk)** — environ 79 Mo. [Publication GitHub](https://github.com/Uhama91/DictAI/releases/tag/gemma-test-34404357683), [construction GitHub Actions](https://github.com/Uhama91/DictAI/actions/runs/34404357683). Installer en mise à jour conserve Gemma déjà téléchargé, vocabulaire et notes. Une note ouverte volontairement utilise maintenant la pastille pour pause/reprise ; **Insérer…** affiche une confirmation avant de déposer son texte ailleurs. Le parcours message reste direct. Correction au premier toucher, commande Modifier, liste de notes hiérarchisée et palette plus chaleureuse : [fonctionnement et essai ciblé 0.9.5](NOTES-ET-EDITION-0.9.5.md). Les tests et l’APK sont vérifiés ; le rendu, le clavier et les gestes de cette version restent à essayer sur appareil.

Texte corrigé conserve le nettoyage des hésitations et les protections de 0.9.4, sans changer le modèle ni ses délais : [fonctionnement 0.9.4](HESITATIONS-TEXTE-CORRIGE-0.9.4.md). Les captures/photos, exports PDF/HTML et le vocabulaire déjà confirmés par Ullie restent acquis.
...
En dictée, un mail de **60 mots ou plus** est de nouveau confié à Gemma. Le délai maximal Mail passe à **8 secondes**, à titre d’essai : l’application utilise une sortie dès qu’elle est prête et validée. Les listes restent à 5 secondes. Les petits acquiescements et certains mails courts conventionnels restent directs. Le diagnostic mentionne la limite réellement utilisée. Cette marge ne prétend pas accélérer le modèle ; les mesures reçues ci-dessous montrent ses limites.

Les mesures CPU sur ordinateur sont 15,399 secondes pour le premier mail long et 24,923 secondes pour le dernier mail de 144 mots. Elles ne prédisent pas le temps GPU du téléphone. Le premier mail avait terminé sur téléphone en 4,978 / 5,136 secondes. Le rapport 0.8.4 complet donne, validation comprise, **5,836 / 5,250 secondes** pour le premier mail et **9,233 / 8,906 secondes** pour le dernier. Ce dernier est structuré mais rejeté dans les deux passages pour la même substitution locale → local ; une attente plus longue seule ne résoudrait pas ce rejet. Les deux passages et le relevé final sont reçus ; aucun nouveau test identique n’est nécessaire pour compléter ce rapport. [Protocole et limites](VERIFICATION-GEMMA-0.8.4.md).
