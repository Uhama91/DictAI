...
| 2026-09-24 | Mode Réunion : spec et plan détaillé rédigés par Astra, conformément à la demande de l'utilisateur. Contrat pastille et gestes ajouté : sélection vers le haut, spirale en écoute, appui pause/reprise, descente en pause pour enregistrer. Développement isolé ; référence médias 665 tests et build Android verts ; sonde native, profils, retouches et brouillon validés, raccordement applicatif en cours, performances Poco non validées. | `docs/superpowers/{specs,plans}/2026-09-24-meeting-mode.md`, `docs/research/meeting-mode/` |
