...
|------|--------|-----------------|
| 2026-09-19 | Pilote Gemma 3 270M V3 intégré derrière `-Pgemma270Pilot=true` : routage « Texte corrigé » français, prompt V3, installation atomique vérifiée par SHA, backend CPU GGUF résident, génération greedy et annulation isolée par session. 542 tests JVM réussis, build pilote et AndroidTest réussis ; APK vérifié avec le GGUF de 291 545 280 octets (SHA `6c4b7b6654c9638287c31e50fd0bf849f33a2ff2dd93bee685bdd9632f20ecf5`). Smoke AVD réel : `Gemma270PilotNativeIntegrationTest` OK (2 tests), parcours UI confirmé sur « Texte corrigé » + moteur local. [CI run 35458263066](https://github.com/Uhama91/DictAI/actions/runs/35458263066) vert ; artefact [`dictai-gemma270-v3-test`](https://github.com/Uhama91/DictAI/actions/runs/35458263066/artifacts/10589061323) contrôlé (APK SHA `de2e1a494c85059e6f7672b3eb3071559cbf54f9e1af0d34b548c2c96b2185c0`). Validation sur téléphone physique et seuil de qualité de 80 % encore à confirmer. | `Gemma270Pilot.kt`, `Gemma270PilotEngine.kt`, `LocalFormatEngine.kt`, `LocalFormatNative.kt`, `LocalFormatting.kt`, `OverlayService.kt`, `MainActivity.kt`, `PostprocessingDiagnostic.kt`, JNI, tests ; APK `app/build/outputs/apk/debug/app-debug.apk` |
